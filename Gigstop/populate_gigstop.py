...
def populate():
    ...
    Django_Django = add_performer("Django Django",'django','django@gmail.com','django@gmail.com','https://youtu.be/9bRR7yo-2UQ', 'Rock')

    Admiral_Fallow = add_performer("Admiral Fallow",'admiral','admiralfallow@gmail.com','admiralfallow@gmail.com','https://youtu.be/oH9IDgyjr4E', 'Jazz')

    Frightened_Rabbit = add_performer("Frightened Rabbit",'rabbit','frightenedrabit@gmail.com','frightenedrabit@gmail.com','https://youtu.be/k-YLMT6qqT4', 'Death Metal')

    Biffy_Clyro = add_performer("Biffy Clyro",'biffy','biffyclyro@gmail.com','biffyclyro@gmail.com','https://youtu.be/YCG_yP5MsMc', 'Pop Rock')

    CHVRCHES = add_performer("CHVRCHES",'chvrches','chvrches@gmail.com','chvrches@gmail.com','https://youtu.be/JyqemIbjcfg', 'Psychadelic Funk Rap')
...
def add_performer(name,username,email,paypal,media,genre):
    c = Performer.objects.get_or_create(name=name,username=username,email=email,paypal=paypal,media=media,genre=genre)
    print "Inserted "+name
    return c
